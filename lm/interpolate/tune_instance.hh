...
// Takes ownership of tune_file
void LoadInstances(int tune_file, const std::vector<StringPiece> &model_names, util::FixedArray<Instance> &instances, Matrix &ln_unigrams);
